...
const id = {
  ...
  langLabel: "Bahasa",
  // projects
  projectsTitle: "Projects — www/",
  emptyTitle: "Belum ada project",
  emptyDesc: "Folder www masih kosong. Klik di bawah buat project pertama — nanti link-nya muncul di atas biar gampang buka.",
  emptyCta: "+ Buat Project Pertamaku",
  newProjectTitle: "Nama Project Baru",
  createDbQ: "Buat Database?",
  createProject: "Buat Project",
  selectProject: "Pilih Project",
  chooseProject: "— pilih project —",
  openFolder: "Buka Folder",
  openFolderLoading: "Buka...",
  openLabel: "Buka",
  copyUrl: "Copy URL",
  copied: "Copied!",
  clickToCopy: "Klik untuk copy URL",
  creatingDb: "Bikin",
  customOk: "custom ok",
  dbInvalid: "harus huruf/_ diawal max 64",
...
const en = {
  ...
  emptyDesc: "The www folder is empty. Click below to create your first project — a link will appear above to open it.",
  emptyCta: "+ Create My First Project",
  newProjectTitle: "New Project Name",
  createDbQ: "Create Database?",
  createProject: "Create Project",
  selectProject: "Select Project",
  chooseProject: "— select project —",
  openFolder: "Open Folder",
  openFolderLoading: "Opening...",
  openLabel: "Open",
  copyUrl: "Copy URL",
  copied: "Copied!",
  ...
  creatingDb: "Creating",
  customOk: "custom ok",
  dbInvalid: "must start with letter/_, max 64",
