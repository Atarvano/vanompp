...
/// Replace {{ROOT}} (forward slashes) and port placeholders.
/// ROOT should already be forward-slash normalized.
pub fn render_httpd(root_forward: &str, apache_port: u16) -> String {
    HTTPD_TEMPLATE
...
mod tests {
    ...
    fn test_render_httpd_contains_placeholders_replaced() {
        let out = render_httpd("C:/Vanompp", 8080);
